...
const cocktails = [
  { name: "Whiskey in the Jar", desc: "Bourbon, honey, lemon, smoked rosemary", price: "$14", icon: Wine },
  { name: "Back in Black IPA", desc: "Dark hoppy ale, citrus notes, 7.2% ABV", price: "$9", icon: Beer },
  { name: "Highway to Helles", desc: "Bavarian lager, crisp and clean, 5.1% ABV", price: "$8", icon: Beer },
  { name: "The Blackout", desc: "Espresso vodka, Kahlúa, cold brew, cream", price: "$15", icon: Wine },
  { name: "Thunderstruck Mule", desc: "Vodka, ginger beer, lime, jalapeño", price: "$13", icon: GlassWater },
  { name: "War Pigs Old Fashioned", desc: "Rye whiskey, bitters, demerara, orange", price: "$16", icon: Wine },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="font-heading text-5xl md:text-7xl font-bold tracking-[0.1em] text-foreground mb-4">
            THE <span className="text-gradient">BAR</span>
          </h2>
